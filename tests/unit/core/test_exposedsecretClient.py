...
class TestExposedsecretClient:
    ...
    def mock_client(self):
        ...
        with (
            patch("app.core.exposedsecretClient.DatabaseClient.__init__"),
    ...
    def test_get_collection(self, mock_client):
        ...
        with patch(
            "app.core.exposedsecretClient.os.getenv", return_value="shield_test"
        ):
    ...
    def test_get_all_with_namespace_filter(self, mock_client):
        ...
        mock_data = [{"_uid": "uid1", "_namespace": "test-ns", "_cluster": "cluster1"}]
    ...
    def test_get_all_with_cluster_filter(self, mock_client):
        ...
        mock_data = [{"_uid": "uid1", "_namespace": "ns1", "_cluster": "test-cluster"}]
