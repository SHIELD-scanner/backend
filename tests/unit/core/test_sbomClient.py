...
class TestSbomClient:
    ...
    def mock_client(self):
        ...
        with patch('app.core.sbomClient.DatabaseClient.__init__'), \
    ...
    def test_get_all_with_namespace_filter(self, mock_client):
        ...
        mock_data = [
            {"_uid": "sbom1", "_namespace": "test-ns", "_cluster": "cluster1"}
        ]
    ...
    def test_get_all_with_cluster_filter(self, mock_client):
        ...
        mock_data = [
            {"_uid": "sbom1", "_namespace": "ns1", "_cluster": "test-cluster"}
        ]
    ...
    def test_format_with_valid_item(self, mock_client):
        ...
        item = {"_uid": "test-sbom", "_namespace": "test-ns", "_cluster": "test-cluster"}
